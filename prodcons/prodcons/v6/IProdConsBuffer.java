...
public interface IProdConsBuffer {
	 ...
	 * blocked until all instances of the message have been consumed Any consumer of
	 * m is also blocked until all the instances of the message have been consumed
	 */
